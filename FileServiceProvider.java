...
//	public static int count = 0;
	...
	@POST
	@Path("/mypost")
	@Consumes(mycollectionType.APPLICATION_JSON)
	@Produces("text/html")
	...
	@POST
	@Path("/upload")
	@Consumes(mycollectionType.MULTIPART_FORM_DATA)
	@Produces("text/html")
	...
	@Produces(mycollectionType.APPLICATION_OCTET_STREAM)
	...
	public Response iStreamVideo(@HeaderParam("Range") String range,
		...
		if (cursor.hasNext()) {
			...
			ResponseBuilder response = Response.ok(file, mycollectionType.APPLICATION_OCTET_STREAM);
